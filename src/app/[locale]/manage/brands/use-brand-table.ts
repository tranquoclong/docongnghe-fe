...
export function useBrandTable(columns: ColumnDef<BrandItem>[]) {
  ...
  const data = BrandListQuery.data?.payload.data ?? []
  ...
  return {
    table, data, BrandIdEdit, setBrandIdEdit, BrandDelete, setBrandDelete
  }
}
